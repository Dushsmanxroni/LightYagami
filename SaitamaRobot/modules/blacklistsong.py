...
import SaitamaRobot.sql.blacklist_sql as sql
from SaitamaRobot.korasong import get_arg


@pbot.on_message(filters.user(OWNER_ID) & filters.command("blacklist"))
...
@pbot.on_message(filters.user(OWNER_ID) & filters.command("unblacklist"))
